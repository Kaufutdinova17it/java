...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Задание 4.1 - Функция (map)
            demonstrateMapFunction(scanner);

            // Задание 4.2 - Фильтр
            demonstrateFilter(scanner);

            // Задание 4.3 - Сокращение (reduce)
            demonstrateReduce(scanner);

            // Задание 4.4 - Коллекционирование
    ...
    private static void demonstrateStorage(Scanner scanner) {
        ...
        Storage<String> stringStorage = new Storage<>(inputString, inputString + " world");
    ...
    private static void demonstrateMapFunction(Scanner scanner) {
        System.out.println("4.1 ДЕМОНСТРАЦИЯ ФУНКЦИИ (MAP):");

        // 1. Строки -> длины строк
        System.out.println("\n4.1.1 Преобразование строк в их длины:");
        ...
        System.out.println("\n4.1.2 Преобразование чисел в абсолютные значения:");
    ...
    private static void demonstrateFilter(Scanner scanner) {
        System.out.println("4.2 ДЕМОНСТРАЦИЯ ФИЛЬТРА:");

        // 1. Фильтрация строк по длине >= 3
        System.out.println("\n4.2.1 Фильтрация строк по длине >= 3:");
        List<String> strings1 = readStringList(scanner, "Введите строки через запятую: ");
        ...
        System.out.println("\n4.2.2 Фильтрация положительных чисел:");
        List<Integer> numbers = readIntList(scanner, "Введите числа через запятую: ");
    ...
    private static void demonstrateReduce(Scanner scanner) {
        System.out.println("4.3 ДЕМОНСТРАЦИЯ СОКРАЩЕНИЯ (REDUCE):");

        // 1. Конкатенация строк
        System.out.println("\n4.3.1 Конкатенация строк:");
        List<String> strings1 = readStringList(scanner, "Введите строки через запятую: ");
    ...
    private static void demonstrateCollect(Scanner scanner) {
        System.out.println("4.4 ДЕМОНСТРАЦИЯ КОЛЛЕКЦИОНИРОВАНИЯ:");

        // 1. Разделение на положительные и отрицательные числа
        System.out.println("\n4.4.1 Разделение чисел на положительные и отрицательные:");
        List<Integer> numbers = readIntList(scanner, "Введите числа через запятую: ");
        ...
        System.out.println("\n4.4.2 Группировка строк по длине:");
        List<String> strings1 = readStringList(scanner, "Введите строки через запятую: ");
